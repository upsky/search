...
my_group = {
    ...
    'label2': '(this thing|is the same|as|label1)', # except absent morphology

    # Всё, что в (скобках) - регулярное вырежение; 1 пробел внутри регулярок означает только 1 пробел.
